...
path='E:/SURF_2/Shared/Dream3DLab (Groupfolder)/1.Projects/BHVD_BEHAV3D/3.Analysis/Ilastik/Exported stats/T_cell/' 
...
## Convert units to um:
df['Center_of_the_object_0']=df['Center_of_the_object_0']*3.54
df['Center_of_the_object_1']=df['Center_of_the_object_1']*3.54
df['Center_of_the_object_2']=df['Center_of_the_object_2']*1.2
...
def coord_to_series(data):  
    ...
    for track in data['TrackID2'].unique():
        ...
        df_sliced2 = df_sliced[['Center_of_the_object_0', 'Center_of_the_object_1', 'Center_of_the_object_2']] ## select the data of interest
        # convert to array
