...
### We need to reprocess the tracks, this time selecting tracks of a longer length (the time that the experiment lasts). We will only select the tracks that fall in the range of the experiment that will
...
master<-readRDS(paste0(main_output_dir,"/tcell_behavior/results/raw_tcell_track_data.rds"))
