...
| 4 | 📍 **Tracking** | Per cell-type subtabs: Propagation (organoids), btrack (motile cells), or Import existing. Manual editing of tracked segments lives in the Visualization tab. | [Tracking](processing/tracking/index) |
