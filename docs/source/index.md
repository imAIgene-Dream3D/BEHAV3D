...
Segmentation (6 methods, including zero-shot Cellpose-SAM) and Tracking (LAP, TrackPy, Propagation, Reporter Propagation, btrack, Import) — the heavy computation that turns images into trackable cells.
::::
